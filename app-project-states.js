...
// Nivells de progrés (1-5 estrelles)
const PROGRESS_LEVELS = {
  1: { label: 'Fase inicial', percent: 20, stars: '⭐☆☆☆☆' },
  2: { label: 'En desenvolupament', percent: 40, stars: '⭐⭐☆☆☆' },
  3: { label: 'A meitat', percent: 60, stars: '⭐⭐⭐☆☆' },
  4: { label: 'Gairebé acabat', percent: 80, stars: '⭐⭐⭐⭐☆' },
  5: { label: 'A punt', percent: 100, stars: '⭐⭐⭐⭐⭐' }
};

/* ================= FUNCIONS D'ESTAT ================= */

// Establir l'estat d'un client
...
async function setClientProgress(clientId, level) {
  ...
  client.progressStars = PROGRESS_LEVELS[level].stars;
...
// Renderitzar selector de progrés
  ...
  return `
    <div class="project-progress-section">
      ...
      <div class="progress-stars" id="progressStars">
        ${[1, 2, 3, 4, 5].map(level => `
          <button class="progress-star ${level <= currentProgress ? 'active' : ''}" data-level="${level}">
      ...
      <div class="progress-bar">
        <div class="progress-fill" style="width: ${PROGRESS_LEVELS[currentProgress].percent}%"></div>
      </div>
          ...
          return `
            <div class="state-history-item">
              ...
              <div class="state-history-content">
                ...
                <div class="state-history-date">${dateStr} · ${timeStr} · ${entry.progress}★</div>
